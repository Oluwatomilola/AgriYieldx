      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            Use these tokens to invest in farms or purchase produce from our marketplace.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-lg p-4 shadow-sm">
              <h4 className="font-semibold mb-2">Need HBAR?</h4>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Claim Tokens</h3>
              <p className="text-sm text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What is hUSDT?</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">How often can I claim?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Why do I need HBAR?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What can I do with test tokens?</h3>
              <p className="text-gray-600 text-sm">
                Use hUSDT to:
              </p>
              <ul className="list-disc list-inside text-gray-600 text-sm mt-2 ml-4">
                <li>Invest in farm crowdfunding campaigns</li>
                <li>Purchase agricultural produce from the marketplace</li>
