...
async function main() {
  ...
  console.log("Testing investment from:", signer.address);
  ...
  console.log("  Funding Goal:", ethers.formatUnits(farm.fundingGoal, 6));
  console.log("  Share Price:", ethers.formatUnits(farm.sharePrice, 6));
  console.log("  Share Supply:", farm.shareSupply.toString());
  console.log("  Raised:", ethers.formatUnits(farm.raised, 6));
